...
class MTREncoder(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        obj_trajs = obj_trajs[None,:].cuda()

        obj_trajs_mask= input_dict['obj_trajs_mask']
        obj_trajs_mask = obj_trajs_mask [None, :].cuda()
        map_polylines = input_dict['map_polylines']
        map_polylines = map_polylines[None, :].cuda()
        map_polylines_mask =input_dict['map_polylines_mask']
        map_polylines_mask = map_polylines_mask[None, :].cuda() 

        obj_trajs_pos = input_dict['obj_trajs_pos']
        obj_trajs_heading = input_dict['obj_trajs_heading'].cuda() 
        ...
        print ('input feature encoding done write')
        print(obj_polylines_feature.shape, map_polylines_feature.shape)
        # apply self-attn
