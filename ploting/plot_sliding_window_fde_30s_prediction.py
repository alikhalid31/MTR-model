...
folder_path = './../output/waymo/mtr+sliding_window_training/10s_history_30s_future_debuging_mode_1_custome_eval/eval/epoch_30/default'
output_path =  './output/custom_eval/debuging_all_data/w_data_augmentation/mode_1'
